...
```bash
"${CLAUDE_PLUGIN_ROOT}/scripts/ask-codex.sh" --codex-model gpt-5.6-sol:high "Review the following round summary (M4)..."
```
...
- Default model is `gpt-5.6-sol:high` with a 3600-second timeout
