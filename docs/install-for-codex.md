...
- Use RLCR defaults: `codex exec` with `gpt-5.6:high`, `codex review` with `gpt-5.6:high`
...
- `${XDG_CONFIG_HOME:-~/.config}/humanize/config.json` contains `bitlesson_model` set to a Codex/OpenAI model such as `gpt-5.6`
