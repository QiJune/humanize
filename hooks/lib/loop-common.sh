...
# Precedence: pre-set value > config value > hardcoded fallback (gpt-5.6-sol/high)
#
...
# Precedence: pre-set by caller > config value > hardcoded fallback (gpt-5.6-sol/high)
...
DEFAULT_CODEX_MODEL="${DEFAULT_CODEX_MODEL:-${_cfg_codex_model:-gpt-5.6-sol}}"
